...
let profit = cars.map(car => {
    return car.gross_profit
})

let totalProfit = profit.reduce((currentProfit, newProfit) => currentProfit += newProfit, 0)
console.log(Math.floor(totalProfit))
...
cars.forEach(sale => {
    if(sale.purchase_date.split("-")[1] === "01") {
        bestMonth.jan ++
    }else if(sale.purchase_date.split("-")[1] === "02") {
        bestMonth.feb ++
    }else if(sale.purchase_date.split("-")[1] === "03") {
        bestMonth.mar ++
    }else if(sale.purchase_date.split("-")[1] === "04") {
        bestMonth.apr ++
    }else if(sale.purchase_date.split("-")[1] === "05") {
        bestMonth.may ++
    }else if(sale.purchase_date.split("-")[1] === "06") {
        bestMonth.june ++
    }else if(sale.purchase_date.split("-")[1] === "07") {
        bestMonth.jul ++
    }else if(sale.purchase_date.split("-")[1] === "08") {
        bestMonth.aug ++
    }else if(sale.purchase_date.split("-")[1] === "09") {
        bestMonth.sep ++
    }else if(sale.purchase_date.split("-")[1] === "10") {
        bestMonth.oct ++
    }else if(sale.purchase_date.split("-")[1] === "11") {
        bestMonth.nov ++
    }else if(sale.purchase_date.split("-")[1] === "12") {
        bestMonth.dec ++
    }
...
for(let key in bestMonth) {
    
    if(bestMonth[key] > bestTotal.total){
        bestTotal.total = bestMonth[key]
        bestTotal.month = `${key}`
    }
}

console.log(bestTotal.month)